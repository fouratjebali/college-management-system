...
Le projet est organisé en \textbf{six sprints} : un sprint d'initialisation technique, quatre sprints fonctionnels alignés sur les modules réellement livrés, puis un sprint final réservé aux tests, à la validation et à la finalisation.
...
\hline
Sprint 5 & À définir & Tests, validation et finalisation du projet & À compléter \\
\hline
\end{tabular}
\end{table}
